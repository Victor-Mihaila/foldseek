...
#ifndef BENCHMARK_HALF2_SCOREONLY_CUH
#define BENCHMARK_HALF2_SCOREONLY_CUH
...
struct ForEachCombination_call_singleconfigFunction{
    ...
    BenchmarkData helper2(
        ...
        if constexpr(ApproachAndType::datatype == Datatype::Half2){
...
std::vector<BenchmarkData> benchmark_half2_scoreOnly_multiTile(
    int timingIterations, 
    std::chrono::milliseconds sleepAmount,
    bool checkResults,
    int tiles
